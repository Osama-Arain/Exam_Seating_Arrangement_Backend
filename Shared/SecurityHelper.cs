...
namespace ESA.Shared
{
    public static class SecurityHelper
    {
        ...
        public async static Task<ApiResponse> KeyValidation(string _Key)
        {
            ...
            // _UserLoginInfoViewModel.TenantId = (Guid)_UserKey.TenantId;
        ...
        public static async Task<ApiResponse> UserMenuPermissionAsync(Guid _MenuId, ClaimsPrincipal _User)
        {
            ...
            //                         join _Branch in _context.Tenants on _UserKey.TenantId equals _Branch.Id
            ...
            //                             TenantId = (Guid)_UserKey.TenantId,
            ...
            apiResponse.statusCode = StatusCodes.Status200OK.ToString();
            apiResponse.data = apiResponse; /*_Permission;*/
            return apiResponse;
        }
    }
}